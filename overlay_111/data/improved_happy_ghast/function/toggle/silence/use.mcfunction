...
execute as @a[tag=improved_happy_ghast.player,gamemode=!creative,distance=..10,sort=nearest,limit=1] run item modify entity @s weapon.mainhand [{type:"minecraft:set_count",count:-1,add:true}]
